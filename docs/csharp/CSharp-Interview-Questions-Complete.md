# C# Interview Questions – Complete Guide (Basic to Advanced)
...
**Q24. What is the difference between class and struct?**  
...
**Q25. When should you use a struct instead of a class?**  
...
**Q26. Can a struct have a default constructor?**  
...
**Q27. Can a struct inherit from another struct or class?**  
...
**Q31. When should you use an interface vs abstract class?**  
...
**Q36. What is a parameterless (default) constructor?**  
...
**Q38. What is a static constructor?**  
...
**Q39. What is a destructor (finalizer)?**  
...
**Q40. What is the difference between `Dispose()` and destructor?**  
...
**Q42. What is the difference between static and instance methods?**  
...
**Q43. Can a static class have instance members?**  
...
**Q44. Can you have a static constructor in a non-static class?**  
...
**Q46. What is the difference between value types and reference types?**  
...
**Q47. Where are value types and reference types stored?**  
...
**Q48. What happens when you assign one value type to another?**  
A. A copy of the value is created. Changes to one variable do not affect the other.

**Q49. What happens when you assign one reference type to another?**  
...
**Q54. What is the difference between `ref` and `out`?**  
...
**Q55. When should you use `in` instead of `ref`?**  
...
**Q56. What is the difference between `readonly` and `const`?**  
...
**Q57. Can you change a `readonly` field after it's assigned?**  
...
**Q60. What is the difference between `var`, `dynamic`, and `object`?**  
...
**Q61. When should you use `dynamic`?**  
...
**Q64. What is exception handling?**  
...
**Q65. What is the difference between `throw` and `throw ex`?**  
...
**Q67. What is the difference between `Exception` and `ApplicationException`?**  
...
**Q68. What are checked vs unchecked exceptions in C#?**  
...
**Q69. What is the `using` statement?**  
...
**Q70. What is exception filtering (C# 6)?**  
...
**Q72. What is the difference between `List<T>` and `ArrayList`?**  
...
**Q73. What is the difference between `Array` and `List<T>`?**  
...
**Q76. What is the difference between `ICollection<T>` and `IList<T>`?**  
...
**Q77. What are generic constraints?**  
...
**Q78. What is covariance and contravariance?**  
...
**Q80. What is the difference between `IEnumerable<T>` and `IQueryable<T>`?**  
...
**Q81. What is deferred execution in LINQ?**  
...
**Q82. What is the difference between `Where()` and `Select()`?**  
...
**Q83. What is the difference between `First()` and `FirstOrDefault()`?**  
...
**Q84. What is the difference between `Any()` and `All()`?**  
...
**Q85. What is method syntax vs query syntax in LINQ?**  
...
**Q87. What is a multicast delegate?**  
...
**Q88. What is the difference between delegates and events?**  
...
**Q89. What are `Func`, `Action`, and `Predicate`?**  
...
**Q90. What is the difference between `Func<T>` and `Action<T>`?**  
...
**Q91. What is an anonymous method?**  
...
**Q93. What is the difference between `Func<int, int>` and `Expression<Func<int, int>>`?**  
...
**Q94. What is the difference between synchronous and asynchronous code?**  
...
**Q97. What is the difference between `Task.Run()` and `Task.Factory.StartNew()`?**  
...
**Q98. What is the difference between `Task` and `Thread`?**  
...
**Q99. What happens if you don't `await` a `Task`?**  
...
**Q100. What is `ConfigureAwait(false)`?**  
...
**Q101. What is the difference between `Task.WaitAll()` and `Task.WhenAll()`?**  
...
**Q103. What is the Garbage Collector (GC)?**  
...
**Q105. What is the difference between `Dispose()` and `Finalize()`?**  
...
**Q106. What is the `IDisposable` interface?**  
...
**Q107. What is the Large Object Heap (LOH)?**  
...
**Q108. What is a memory leak in .NET?**  
...
**Q109. What is the difference between stack and heap?**  
...
**Q111. What is Dependency Injection (DI)?**  
...
**Q112. What are the benefits of Dependency Injection?**  
...
**Q113. What are the three types of Dependency Injection?**  
...
**Q114. What are service lifetimes in ASP.NET Core DI?**  
...
**Q115. What is the difference between Transient and Scoped?**  
...
**Q117. What is constructor injection?**  
...
**Q118. What is the Common Language Runtime (CLR)?**  
...
**Q119. What is Just-In-Time (JIT) compilation?**  
...
**Q120. What is the Common Type System (CTS)?**  
...
**Q121. What is the Common Language Specification (CLS)?**  
...
**Q122. What is Intermediate Language (IL/MSIL)?**  
...
**Q124. What is the Global Assembly Cache (GAC)?**  
...
**Q125. What is the difference between .NET Framework and .NET Core/.NET 5+?**  
...
**Q129. What is the difference between `is` and `as` keywords?**  
...
**Q130. What is pattern matching (C# 7+)?**  
...
**Q131. What is a nullable reference type (C# 8)?**  
...
**Q132. What is the `nameof` operator?**  
...
**Q135. What is the `yield` keyword?**  
...
**Q136. What is the difference between `IEnumerable` and `IEnumerator`?**  
...
**Q137. What is covariance in delegates?**  
...
**Q138. What is the `lock` statement?**  
...
**Q139. What is the `volatile` keyword?**  
...
**Q140. What is the `params` keyword?**  
...
**Q141. What is operator overloading?**  
...
**Q145. What is an anonymous type?**  
...
**Q146. What is implicit vs explicit interface implementation?**  
...
**Q147. What is the `default` keyword?**  
...
**Q148. What is short-circuiting in logical operators?**  
...
**Q149. What is the conditional (ternary) operator?**  
...
**Q150. What is the null-coalescing operator (`??`)?**  
